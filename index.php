...
<html lang="en">
    ...
    <div class="container">
        <div class="page-header">
            <h1 id="about">About</a> <small>Työnkuva</small></h1>
        </div>
        ...
        <ul>
            <li>Projektinhallinta (Agile / Jira) ja dokumentointi
                <ul>
                    <li>Ketterät kehitysmenetelmät</li>
                    <li>Koodin katselmointi & suunnittelu</li>
                </ul>
            </li>

            <li>Keskitetty koodinhallinta (Continuous Integration / SVN)
                <ul>
                    <li>CI-palvelimen käyttö & versionhallinta</li>
                    <li>Buildien hallinta ja raportointi (ja niiden ymmärtäminen)</li>
                </ul>
            </li>

            <li>Palvelinylläpito
                <ul>
                    <li>Windows- ja Linux-palvelin</li>
                </ul>
            </li>

            <li>Testausympäristö (Symfony2 ja Zend -projektit)
                <ul>
                    <li>PHPunit, testien kirjoittaminen ja ajaminen</li>
                </ul>
            </li>

            <li>Legacy-ylläpito
                <ul>
                    <li>PHP-versioiden päivittäminen</li>
                    <li>Vanhan koodin refaktorointia ja aukkojen paikkaamista</li>
                </ul>
            </li>

            <li>Käyttöliittymät
                <ul>
                    <li>Javascript, Web grafiikka, layout-suunnitelu</li>
                </ul>
            </li>

            <li>Olio-ohjelmointi
                <ul>
                    <li>TTD, Olio-keskitetty ohjelmistokehykset</li>
                </ul>
            </li>
        </ul>
